	...
	<div class="container">
		<div class="main row">
			...
			<div class="col-md-6 content_right">
				<h4>You like this brand new concept? What are you waiting for? <span>Join us today!</span></h4>
				<p class="para">Be part of this awesome community and join us today! You will be one of the thousands avonturic members.
				 Joining the comunity can be done in a lot of ways; registering, using you facebook, twitter, etc.
				  </p>
