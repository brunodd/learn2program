...
duidelijke tutorials. Laravel gebruikt MVC design, wat we dan ook gevolgd hebben. Voor alle grote klasses
werd een Controller aangemaakt. Deze Controller bevat de voornaamste php code. De resultaten die in de
Controller behaald worden, worden dan gebruikt om Views te creeren die de content geformateerd renderen (als html code).
